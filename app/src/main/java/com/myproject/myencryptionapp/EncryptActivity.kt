    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == 1
            ...
            resultData?.data?.also { uri2 ->
                ...
                saveEncryptedText(aes_enc_txt.toByteArray(), applicationContext, uri2)
...
//        encryptextTextResult.setText(encodedString)
    ...
    fun encrypt(strToEncrypt: String): String? {
        try {
            ...
            val hasil_enc_aes = Base64.encodeToString(
                cipher.doFinal(strToEncrypt.toByteArray(Charsets.UTF_8)),
                Base64.DEFAULT
            )
            println("Hasil Enc = " + hasil_enc_aes)

            val aes_enc_txt = findViewById<TextView>(R.id.fieldEncryptedText)
            aes_enc_txt.setText(hasil_enc_aes)

            return hasil_enc_aes
